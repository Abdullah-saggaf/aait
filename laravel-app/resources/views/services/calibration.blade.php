...
<section class="page-hero">
    <div class="container">
        <h1 class="mb-3">Calibration Services</h1>
        <p class="lead mb-0">Professional calibration services for Mechanical, Electro-Technical, and Thermal measuring & source instruments, aligned with ISO/IEC-17025:2005 standards.</p>
    </div>
</section>
...
<section class="py-5">
    <div class="container">
        <h2 class="section-title text-center mb-5">Calibration Scope</h2>
