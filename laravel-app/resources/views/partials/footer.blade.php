    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 mb-4">
                <img src="{{ asset('images/logo3.svg') }}" alt="National Engineering Organization" height="40" class="mb-3">
        ...
        <div class="row">
            <div class="col-md-6">
                <p class="mb-0">&copy; {{ date('Y') }} National Engineering Organization. All rights reserved.</p>
            </div>
