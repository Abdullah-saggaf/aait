...
<section class="page-hero">
    <div class="container">
        <h1 class="mb-3">Personal Certification</h1>
        <p class="lead mb-0">Certification programs for technicians and personnel validating competency and adherence to calibration standards.</p>
    </div>
</section>
            ...
            <div class="col-lg-8 mx-auto">
                ...
                <div class="card neo-card mt-5">
                    <div class="card-body p-4">
                        <h5 class="text-neo-navy mb-3"><i class="bi bi-shield-check text-neo-lime me-2"></i>Validate Personal Certificate</h5>
                        <p class="mb-3">Enter the certificate ID to verify authenticity (Demo Feature)</p>
                        <div class="row g-3">
                            <div class="col-md-8">
                                <input type="text" class="form-control" placeholder="Enter Certificate ID (e.g. PER-2024-00123)" id="certId">
                            </div>
                            <div class="col-md-4">
